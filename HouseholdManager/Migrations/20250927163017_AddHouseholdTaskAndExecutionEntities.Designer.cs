...
namespace HouseholdManager.Migrations
{
    ...
    [Migration("20250927163017_AddHouseholdTaskAndExecutionEntities")]
    partial class AddHouseholdTaskAndExecutionEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HouseholdManager.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HouseholdManager.Models.HouseholdMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HouseholdManager.Models.HouseholdTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HouseholdManager.Models.TaskExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HouseholdManager.Models.HouseholdMember", b =>
                {
                    ...
                    b.HasOne("HouseholdManager.Models.ApplicationUser", "User")
            ...
            modelBuilder.Entity("HouseholdManager.Models.HouseholdTask", b =>
                {
                    b.HasOne("HouseholdManager.Models.ApplicationUser", "AssignedUser")
                    ...
                    b.HasOne("HouseholdManager.Models.Room", null)
            ...
            modelBuilder.Entity("HouseholdManager.Models.TaskExecution", b =>
                {
                    ...
                    b.HasOne("HouseholdManager.Models.HouseholdMember", null)
                    ...
                    b.HasOne("HouseholdManager.Models.HouseholdTask", "Task")
                        .WithMany("Executions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HouseholdManager.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
